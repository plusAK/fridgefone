...
public class LoadingActivity extends AwesomeSplash {
    ...
    public void initSplash(ConfigSplash configSplash) {
        ...
        configSplash.setBackgroundColor(R.color.loading_screen_color); //any color you want form colors.xml
        configSplash.setAnimCircularRevealDuration(1700); //int ms
        ...
        //Customize Logo
        configSplash.setLogoSplash(R.drawable.edited_salt_bae); //or any other drawable
